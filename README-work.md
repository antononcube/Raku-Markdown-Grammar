...
| Jupyter     | [Jupyter](https://jupyter.org), [Jupyter::Converter](https://raku.land/zef:antononcube/Jupyter::Converter)                                                                                                                  |                                                                                                                       | [Jupyter](https://jupyter.org), [jupytext](https://jupytext.readthedocs.io), [Jupyter::Converter](https://raku.land/zef:antononcube/Jupyter::Converter) |                                                                                                                                                                                |  [Jupyter::Converter](https://raku.land/zef:antononcube/Jupyter::Converter)                                                                        |                                                                                                        | [JSON::Fast](https://raku.land/cpan:TIMOTIMO/JSON::Fast), [Jupyter::Converter](https://raku.land/zef:antononcube/Jupyter::Converter) |
...
**Remark:** [Pandoc](https://pandoc.org) attempts to be a universal converter, applicable for all couples of formats.
...
The CLI script `from-markdown` takes both file names and (Markdown) text. Here is a usage example for the latter:
...
[AAp3] Anton Antonov
[Jupyter::Converter, Raku package](https://github.com/antononcube/Raku-Jupyter-Converter),
(2025),
[GitHub/antononcube](https://github.com/antononcube/Raku-Jupyter-Converter).
